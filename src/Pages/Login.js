    ...
    <hr/>
          ...
          <Formik initialValues={initialValues}
           ...
           {({value,errors,touched,handleBlur,handleChange,handleSubmit}) => ( <form onSubmit={handleSubmit}>
            <TextField sx={{bgcolor:"rgb(242, 214, 214)"}} type="email" label="Name" name="email"  variant="outlined"  placeholder="Enter your email" id="email" onChange={handleChange} onBlur={handleBlur}/><br/>
